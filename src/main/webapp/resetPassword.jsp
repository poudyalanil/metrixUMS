...
%>
<%
    String errorMsg = (String) session.getAttribute("errorReset");
%>
                        ...
                        <div class="container">
                            <div class="row"  >
                                <div class="col-md-9 col-lg-8 mx-auto" >
                                    <h3 class="login-heading mb-4"><span>Reset</span>Password</h3>
                                    <form class="form-signin" method="POST" action="${pageContext.request.contextPath}/ResetPasswordUser">  
                                        <div class="form-label-group">
                                            <input type="email" name="emailReset" class="form-control" placeholder="Email address" required>
                                            <label for="email">Email address</label>
                                        </div>
                                     
                                        <div style="text-align: center;">
                                            <button class="btn btn-md btn-outline-light btn-login" type="submit" >Reset Password</button>
                                            <br><br>
                                            <% if (errorMsg != null) {%>
